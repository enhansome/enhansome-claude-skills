...
* [docx](https://github.com/anthropics/skills/tree/main/skills/docx) ⭐ 169,174 | 🐛 1,086 | 🌐 Python | 📅 2026-08-13 - Create, edit, analyze Word docs with tracked changes, comments, formatting.
* [pdf](https://github.com/anthropics/skills/tree/main/skills/pdf) ⭐ 169,174 | 🐛 1,086 | 🌐 Python | 📅 2026-08-13 - Extract text, tables, metadata, merge & annotate PDFs.
* [pptx](https://github.com/anthropics/skills/tree/main/skills/pptx) ⭐ 169,174 | 🐛 1,086 | 🌐 Python | 📅 2026-08-13 - Read, generate, and adjust slides, layouts, templates.
* [xlsx](https://github.com/anthropics/skills/tree/main/skills/xlsx) ⭐ 169,174 | 🐛 1,086 | 🌐 Python | 📅 2026-08-13 - Spreadsheet manipulation: formulas, charts, data transformations.
...
* [Master Claude for Legal](https://github.com/sboghossian/master-claude-for-legal) ⭐ 54 | 🐛 1 | 📅 2026-05-18 - Skill pack for legal teams. NDA triage, multi-party version diff, citation verifier, meeting brief, and the Friday-newsletter status synthesis pattern. Includes 10 reference docs (privilege, verification, long documents, practice areas) and 3 firm templates. Built from the public Anthropic Claude for Legal Teams webinar dataset. *By [@sboghossian](https://github.com/sboghossian)*

### Development & Code Tools

* [finishing-a-development-branch](https://github.com/obra/superpowers/tree/main/skills/finishing-a-development-branch) ⭐ 271,849 | 🐛 329 | 🌐 Shell | 📅 2026-08-13 - Guides completion of development work by presenting clear options and handling chosen workflow.
* [test-driven-development](https://github.com/obra/superpowers/tree/main/skills/test-driven-development) ⭐ 271,849 | 🐛 329 | 🌐 Shell | 📅 2026-08-13 - Use when implementing any feature or bugfix, before writing implementation code.
* [using-git-worktrees](https://github.com/obra/superpowers/blob/main/skills/using-git-worktrees/) ⭐ 271,849 | 🐛 329 | 🌐 Shell | 📅 2026-08-13 - Creates isolated git worktrees with smart directory selection and safety verification.
* [artifacts-builder](https://github.com/anthropics/skills/tree/main/skills/web-artifacts-builder) ⭐ 169,174 | 🐛 1,086 | 🌐 Python | 📅 2026-08-13 - Suite of tools for creating elaborate, multi-component claude.ai HTML artifacts using modern frontend web technologies (React, Tailwind CSS, shadcn/ui).
* [Skill Seekers](https://github.com/yusufkaraaslan/Skill_Seekers) ⭐ 14,756 | 🐛 46 | 🌐 Python | 📅 2026-08-09 - Automatically converts any documentation website into a Claude AI skill in minutes. *By [@yusufkaraaslan](https://github.com/yusufkaraaslan)*
* [reddit-fetch](https://github.com/ykdojo/claude-code-tips/tree/main/skills/reddit-fetch) ⭐ 9,614 | 🐛 4 | 🌐 HTML | 📅 2026-08-06 - Fetches Reddit content via Gemini CLI when WebFetch is blocked or returns 403 errors.
* [lean-ctx](https://github.com/yvgude/lean-ctx) ⭐ 3,573 | 🐛 13 | 🌐 Rust | 📅 2026-08-13 - MCP server and context runtime for AI coding agents: session caching, AST-aware compression, and 90+ shell patterns to reduce token usage. Supports Claude Code, Cursor, Copilot, and other integrations. Install the Claude Code skill with `lean-ctx init --agent claude-code`; docs at [leanctx.com](https://leanctx.com). *By [@yvgude](https://github.com/yvgude)*
* [Playwright Browser Automation](https://github.com/lackeyjb/playwright-skill) ⭐ 3,026 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-11 - Model-invoked Playwright automation for testing and validating web applications. *By [@lackeyjb](https://github.com/lackeyjb)*
* [prompt-engineering](https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/customaize-agent/skills/prompt-engineering) ⭐ 1,333 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-13 - Teaches well-known prompt engineering techniques and patterns, including Anthropic best practices and agent persuasion principles.
* [software-architecture](https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/ddd/skills/software-architecture) ⭐ 1,333 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-13 - Implements design patterns including Clean Architecture, SOLID principles, and comprehensive software design best practices.
* [subagent-driven-development](https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/sadd/skills/subagent-driven-development) ⭐ 1,333 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-13 - Dispatches independent subagents for individual tasks with code review checkpoints between iterations for rapid, controlled development.
* [iOS Simulator](https://github.com/conorluddy/ios-simulator-skill) ⭐ 1,212 | 🐛 20 | 🌐 Python | 📅 2026-06-18 - Enables Claude to interact with iOS Simulator for testing and debugging iOS applications. *By [@conorluddy](https://github.com/conorluddy)*
* [jules](https://github.com/sanjay3290/ai-skills/tree/main/skills/jules) ⭐ 398 | 🐛 3 | 🌐 Python | 📅 2026-07-09 - Delegate coding tasks to Google Jules AI agent for async bug fixes, documentation, tests, and feature implementation on GitHub repos. *By [@sanjay3290](https://github.com/sanjay3290)*
...
* [Claude Code Terminal Title](https://github.com/bluzername/claude-code-terminal-title) ⭐ 135 | 🐛 5 | 🌐 Shell | 📅 2026-01-31 - Gives each Claud-Code terminal window a dynamic title that describes the work being done so you don't lose track of what window is doing what.
...
* [root-cause-tracing](https://github.com/obra/superpowers/tree/main/skills/root-cause-tracing) ⭐ 271,849 | 🐛 329 | 🌐 Shell | 📅 2026-08-13 - Use when errors occur deep in execution and you need to trace back to find the original trigger.
...
* [deep-research](https://github.com/sanjay3290/ai-skills/tree/main/skills/deep-research) ⭐ 398 | 🐛 3 | 🌐 Python | 📅 2026-07-09 - Execute autonomous multi-step research using Gemini Deep Research Agent for market analysis, competitive landscaping, and literature reviews. *By [@sanjay3290](https://github.com/sanjay3290)*
...
* [brainstorming](https://github.com/obra/superpowers/tree/main/skills/brainstorming) ⭐ 271,849 | 🐛 329 | 🌐 Shell | 📅 2026-08-13 - Transform rough ideas into fully-formed designs through structured questioning and alternative exploration.
* [NotebookLM Integration](https://github.com/PleasePrompto/notebooklm-skill) ⭐ 7,620 | 🐛 38 | 🌐 Python | 📅 2025-11-21 - Lets Claude Code chat directly with NotebookLM for source-grounded answers based exclusively on uploaded documents. *By [@PleasePrompto](https://github.com/PleasePrompto)*
...
* [swiftui-design-skill](https://github.com/wholiver/swiftui-design-skill) ⭐ 166 | 🐛 0 | 📅 2026-05-01 - SwiftUI 前端设计 skill — 反 AI Slop 六条铁律、设计方向顾问、品牌资产协议、五维评审。支持 Claude Code / Cursor / Codex / OpenCode 等全部 AI agent 平台。 *By [@wholiver](https://github.com/wholiver)*
* [anydesign](https://github.com/uxKero/anydesign) ⭐ 156 | 🐛 0 | 🌐 Python | 📅 2026-06-11 - Analyzes any image, URL, or Figma file and generates a structured `design.md` with the full design system, component inventory, and reconstruction notes — portable to v0, Lovable, Cursor or any AI builder. *By [@uxKero](https://github.com/uxKero)*
...
* [kaizen](https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/kaizen/skills/kaizen) ⭐ 1,333 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-13 - Applies continuous improvement methodology with multiple analytical approaches, based on Japanese Kaizen philosophy and Lean methodology.
...
* [google-workspace-skills](https://github.com/sanjay3290/ai-skills/tree/main/skills) ⭐ 398 | 🐛 3 | 🌐 Python | 📅 2026-07-09 - Suite of Google Workspace integrations: Gmail, Calendar, Chat, Docs, Sheets, Slides, and Drive with cross-platform OAuth. *By [@sanjay3290](https://github.com/sanjay3290)*
* [outline](https://github.com/sanjay3290/ai-skills/tree/main/skills/outline) ⭐ 398 | 🐛 3 | 🌐 Python | 📅 2026-07-09 - Search, read, create, and manage documents in Outline wiki instances (cloud or self-hosted). *By [@sanjay3290](https://github.com/sanjay3290)*
...
* [ASD-AuDHD-PAI-Skills](https://github.com/emory/ASD-AuDHD-PAI-Skills) ⭐ 34 | 🐛 0 | 📅 2025-12-17 - New collection, first skill [pda-reframing](https://github.com/emory/ASD-AuDHD-PAI-Skills/blob/main/Skills/pda-reframing/SKILL.md) ⭐ 34 | 🐛 0 | 📅 2025-12-17 can reframe requests or decisions to defeat Persistent Demand Avoidance flavors of autism spectrum disorders, or people with ADHD that struggle to Start tasks and need help aligning with a task.
...
* [Anthropic Skills Repository](https://github.com/anthropics/skills) ⭐ 169,174 | 🐛 1,086 | 🌐 Python | 📅 2026-08-13 - Official example skills
