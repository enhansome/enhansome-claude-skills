# Awesome claude skills with stars
...
* [docx](https://github.com/anthropics/skills/tree/main/skills/docx) ⭐ 170,527 | 🐛 1,123 | 🌐 Python | 📅 2026-08-18 - Create, edit, analyze Word docs with tracked changes, comments, formatting.
* [pdf](https://github.com/anthropics/skills/tree/main/skills/pdf) ⭐ 170,527 | 🐛 1,123 | 🌐 Python | 📅 2026-08-18 - Extract text, tables, metadata, merge & annotate PDFs.
* [pptx](https://github.com/anthropics/skills/tree/main/skills/pptx) ⭐ 170,527 | 🐛 1,123 | 🌐 Python | 📅 2026-08-18 - Read, generate, and adjust slides, layouts, templates.
* [xlsx](https://github.com/anthropics/skills/tree/main/skills/xlsx) ⭐ 170,527 | 🐛 1,123 | 🌐 Python | 📅 2026-08-18 - Spreadsheet manipulation: formulas, charts, data transformations.
...
* [Master Claude for Legal](https://github.com/sboghossian/master-claude-for-legal) ⭐ 56 | 🐛 1 | 📅 2026-05-18 - Skill pack for legal teams. NDA triage, multi-party version diff, citation verifier, meeting brief, and the Friday-newsletter status synthesis pattern. Includes 10 reference docs (privilege, verification, long documents, practice areas) and 3 firm templates. Built from the public Anthropic Claude for Legal Teams webinar dataset. *By [@sboghossian](https://github.com/sboghossian)*

### Development & Code Tools

* [finishing-a-development-branch](https://github.com/obra/superpowers/tree/main/skills/finishing-a-development-branch) ⭐ 274,404 | 🐛 291 | 🌐 Shell | 📅 2026-08-19 - Guides completion of development work by presenting clear options and handling chosen workflow.
* [test-driven-development](https://github.com/obra/superpowers/tree/main/skills/test-driven-development) ⭐ 274,404 | 🐛 291 | 🌐 Shell | 📅 2026-08-19 - Use when implementing any feature or bugfix, before writing implementation code.
* [using-git-worktrees](https://github.com/obra/superpowers/blob/main/skills/using-git-worktrees/) ⭐ 274,404 | 🐛 291 | 🌐 Shell | 📅 2026-08-19 - Creates isolated git worktrees with smart directory selection and safety verification.
* [artifacts-builder](https://github.com/anthropics/skills/tree/main/skills/web-artifacts-builder) ⭐ 170,527 | 🐛 1,123 | 🌐 Python | 📅 2026-08-18 - Suite of tools for creating elaborate, multi-component claude.ai HTML artifacts using modern frontend web technologies (React, Tailwind CSS, shadcn/ui).
* [Skill Seekers](https://github.com/yusufkaraaslan/Skill_Seekers) ⭐ 14,786 | 🐛 52 | 🌐 Python | 📅 2026-08-09 - Automatically converts any documentation website into a Claude AI skill in minutes. *By [@yusufkaraaslan](https://github.com/yusufkaraaslan)*
* [reddit-fetch](https://github.com/ykdojo/claude-code-tips/tree/main/skills/reddit-fetch) ⭐ 9,813 | 🐛 4 | 🌐 HTML | 📅 2026-08-17 - Fetches Reddit content via Gemini CLI when WebFetch is blocked or returns 403 errors.
* [lean-ctx](https://github.com/yvgude/lean-ctx) ⭐ 3,603 | 🐛 13 | 🌐 Rust | 📅 2026-08-19 - MCP server and context runtime for AI coding agents: session caching, AST-aware compression, and 90+ shell patterns to reduce token usage. Supports Claude Code, Cursor, Copilot, and other integrations. Install the Claude Code skill with `lean-ctx init --agent claude-code`; docs at [leanctx.com](https://leanctx.com). *By [@yvgude](https://github.com/yvgude)*
...
* [prompt-engineering](https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/customaize-agent/skills/prompt-engineering) ⭐ 1,342 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-19 - Teaches well-known prompt engineering techniques and patterns, including Anthropic best practices and agent persuasion principles.
* [software-architecture](https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/ddd/skills/software-architecture) ⭐ 1,342 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-19 - Implements design patterns including Clean Architecture, SOLID principles, and comprehensive software design best practices.
* [subagent-driven-development](https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/sadd/skills/subagent-driven-development) ⭐ 1,342 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-19 - Dispatches independent subagents for individual tasks with code review checkpoints between iterations for rapid, controlled development.
...
* [jules](https://github.com/sanjay3290/ai-skills/tree/main/skills/jules) ⭐ 401 | 🐛 4 | 🌐 Python | 📅 2026-07-09 - Delegate coding tasks to Google Jules AI agent for async bug fixes, documentation, tests, and feature implementation on GitHub repos. *By [@sanjay3290](https://github.com/sanjay3290)*
...
* [Claude Code Terminal Title](https://github.com/bluzername/claude-code-terminal-title) ⭐ 137 | 🐛 5 | 🌐 Shell | 📅 2026-01-31 - Gives each Claud-Code terminal window a dynamic title that describes the work being done so you don't lose track of what window is doing what.
...
* [great\_cto](https://github.com/avelikiy/great_cto) ⭐ 79 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-19 - Claude Code plugin: 7 specialised subagents (tech-lead, senior-dev, qa-engineer, security-officer, devops, l3-support, project-auditor) orchestrating a full SDLC pipeline — architecture, TDD, 12-angle code review, QA, security audit, deploy. 11 project archetypes auto-detected, 13 compliance frameworks (GDPR/PCI-DSS/HIPAA/SOC2/ISO 27001), self-improving knowledge layer that learns from every incident. *By [@avelikiy](https://github.com/avelikiy)*
* [OpenWeb](https://github.com/openweb-org/openweb) ⭐ 50 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-27 - Agent-native way to access any website. Calls the same APIs the website calls (JSON in, JSON out) with auth (cookies, JWT, CSRF, signing) auto-resolved per request. 90+ sites built in. *By [@openweb-org](https://github.com/openweb-org)*
* [overkill](https://github.com/santiago-vargas-de-kruijf/claude-overkill) ⭐ 25 | 🐛 0 | 📅 2026-05-27 - Surfaces advanced, maximalist alternatives to whatever solution is being discussed — advanced data structures, distributed-systems algorithms, niche frameworks, design patterns, and frontier tooling — each ranked on a calibrated complexity scale with learning links and the scenario in which the path pays off. *By [@santiago-vargas-de-kruijf](https://github.com/santiago-vargas-de-kruijf)*
...
* [Full-Page Screenshot](https://github.com/LewisLiu007/full-page-screenshot) ⭐ 15 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-28 - Captures full-page screenshots of web pages via Chrome DevTools Protocol with zero dependencies. *By [@LewisLiu007](https://github.com/LewisLiu007)*
* [building-blog](https://github.com/BuildShipGrowRepeat/nextjs-sanity-blog-skill) ⭐ 6 | 🐛 0 | 📅 2026-05-21 - Adds an SEO-first, i18n-ready blog to a Next.js + Sanity site via a 40-question intake, a one-page plan, and a 20-section spec. Includes a generator for AI hero images via Gemini 3 Pro Image (Nano Banana Pro). *By [@BuildShipGrowRepeat](https://github.com/BuildShipGrowRepeat)*
...
* [root-cause-tracing](https://github.com/obra/superpowers/tree/main/skills/root-cause-tracing) ⭐ 274,404 | 🐛 291 | 🌐 Shell | 📅 2026-08-19 - Use when errors occur deep in execution and you need to trace back to find the original trigger.
...
* [deep-research](https://github.com/sanjay3290/ai-skills/tree/main/skills/deep-research) ⭐ 401 | 🐛 4 | 🌐 Python | 📅 2026-07-09 - Execute autonomous multi-step research using Gemini Deep Research Agent for market analysis, competitive landscaping, and literature reviews. *By [@sanjay3290](https://github.com/sanjay3290)*
...
* [brainstorming](https://github.com/obra/superpowers/tree/main/skills/brainstorming) ⭐ 274,404 | 🐛 291 | 🌐 Shell | 📅 2026-08-19 - Transform rough ideas into fully-formed designs through structured questioning and alternative exploration.
* [NotebookLM Integration](https://github.com/PleasePrompto/notebooklm-skill) ⭐ 7,653 | 🐛 37 | 🌐 Python | 📅 2025-11-21 - Lets Claude Code chat directly with NotebookLM for source-grounded answers based exclusively on uploaded documents. *By [@PleasePrompto](https://github.com/PleasePrompto)*
...
* [swiftui-design-skill](https://github.com/wholiver/swiftui-design-skill) ⭐ 172 | 🐛 0 | 📅 2026-05-01 - SwiftUI 前端设计 skill — 反 AI Slop 六条铁律、设计方向顾问、品牌资产协议、五维评审。支持 Claude Code / Cursor / Codex / OpenCode 等全部 AI agent 平台。 *By [@wholiver](https://github.com/wholiver)*
* [anydesign](https://github.com/uxKero/anydesign) ⭐ 160 | 🐛 0 | 🌐 Python | 📅 2026-06-11 - Analyzes any image, URL, or Figma file and generates a structured `design.md` with the full design system, component inventory, and reconstruction notes — portable to v0, Lovable, Cursor or any AI builder. *By [@uxKero](https://github.com/uxKero)*
* [Pixelbin-Media-Generation](https://github.com/anandpareek-hub/pixelbin-claude-skill) ⭐ 12 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-06 - Generate and edit images & videos with 85+ API portfolio and build visually appealing website pages
...
* [kaizen](https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/kaizen/skills/kaizen) ⭐ 1,342 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-19 - Applies continuous improvement methodology with multiple analytical approaches, based on Japanese Kaizen philosophy and Lean methodology.
...
* [n8n-skills](https://github.com/haunchen/n8n-skills) ⭐ 388 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-17 - Enables AI assistants to directly understand and operate n8n workflows.
* [solo-skills](https://github.com/rockscy/solo-skills) ⭐ 7 | 🐛 0 | 🌐 Shell | 📅 2026-07-01 - 7 bilingual (EN+中文) skills for solo founders and indie devs: launch tweets, customer emails, decision frameworks, postmortems. Each skill includes an explicit "When NOT to use" section.
...
* [git-pushing](https://github.com/mhattingpete/claude-skills-marketplace/tree/main/engineering-workflow-plugin/skills/git-pushing) ⭐ 661 | 🐛 4 | 🌐 HTML | 📅 2026-07-25 - Automate git operations and repository interactions.
* [review-implementing](https://github.com/mhattingpete/claude-skills-marketplace/tree/main/engineering-workflow-plugin/skills/review-implementing) ⭐ 661 | 🐛 4 | 🌐 HTML | 📅 2026-07-25 - Evaluate code implementation plans and align with specs.
* [test-fixing](https://github.com/mhattingpete/claude-skills-marketplace/tree/main/engineering-workflow-plugin/skills/test-fixing) ⭐ 661 | 🐛 4 | 🌐 HTML | 📅 2026-07-25 - Detect failing tests and propose patches or fixes.
* [google-workspace-skills](https://github.com/sanjay3290/ai-skills/tree/main/skills) ⭐ 401 | 🐛 4 | 🌐 Python | 📅 2026-07-09 - Suite of Google Workspace integrations: Gmail, Calendar, Chat, Docs, Sheets, Slides, and Drive with cross-platform OAuth. *By [@sanjay3290](https://github.com/sanjay3290)*
* [outline](https://github.com/sanjay3290/ai-skills/tree/main/skills/outline) ⭐ 401 | 🐛 4 | 🌐 Python | 📅 2026-07-09 - Search, read, create, and manage documents in Outline wiki instances (cloud or self-hosted). *By [@sanjay3290](https://github.com/sanjay3290)*
...
* [computer-forensics](https://github.com/mhattingpete/claude-skills-marketplace/tree/main/computer-forensics-skills/skills/computer-forensics) ⭐ 661 | 🐛 4 | 🌐 HTML | 📅 2026-07-25 - Digital forensics analysis and investigation techniques.
* [file-deletion](https://github.com/mhattingpete/claude-skills-marketplace/tree/main/computer-forensics-skills/skills/file-deletion) ⭐ 661 | 🐛 4 | 🌐 HTML | 📅 2026-07-25 - Secure file deletion and data sanitization methods.
* [metadata-extraction](https://github.com/mhattingpete/claude-skills-marketplace/tree/main/computer-forensics-skills/skills/metadata-extraction) ⭐ 661 | 🐛 4 | 🌐 HTML | 📅 2026-07-25 - Extract and analyze file metadata for forensic purposes.
* [threat-hunting-with-sigma-rules](https://github.com/jthack/threat-hunting-with-sigma-rules-skill) - Use Sigma detection rules to hunt for threats and analyze security events.

### Assistive Technology

* [ASD-AuDHD-PAI-Skills](https://github.com/emory/ASD-AuDHD-PAI-Skills) ⭐ 36 | 🐛 0 | 📅 2025-12-17 - New collection, first skill [pda-reframing](https://github.com/emory/ASD-AuDHD-PAI-Skills/blob/main/Skills/pda-reframing/SKILL.md) ⭐ 36 | 🐛 0 | 📅 2025-12-17 can reframe requests or decisions to defeat Persistent Demand Avoidance flavors of autism spectrum disorders, or people with ADHD that struggle to Start tasks and need help aligning with a task.
...
* [Anthropic Skills Repository](https://github.com/anthropics/skills) ⭐ 170,527 | 🐛 1,123 | 🌐 Python | 📅 2026-08-18 - Official example skills
