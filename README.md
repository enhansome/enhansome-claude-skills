...
* [docx](https://github.com/anthropics/skills/tree/main/skills/docx) ⭐ 171,228 | 🐛 1,145 | 🌐 Python | 📅 2026-08-21 - Create, edit, analyze Word docs with tracked changes, comments, formatting.
* [pdf](https://github.com/anthropics/skills/tree/main/skills/pdf) ⭐ 171,228 | 🐛 1,145 | 🌐 Python | 📅 2026-08-21 - Extract text, tables, metadata, merge & annotate PDFs.
* [pptx](https://github.com/anthropics/skills/tree/main/skills/pptx) ⭐ 171,228 | 🐛 1,145 | 🌐 Python | 📅 2026-08-21 - Read, generate, and adjust slides, layouts, templates.
* [xlsx](https://github.com/anthropics/skills/tree/main/skills/xlsx) ⭐ 171,228 | 🐛 1,145 | 🌐 Python | 📅 2026-08-21 - Spreadsheet manipulation: formulas, charts, data transformations.
...
* [finishing-a-development-branch](https://github.com/obra/superpowers/tree/main/skills/finishing-a-development-branch) ⭐ 276,750 | 🐛 310 | 🌐 Shell | 📅 2026-08-19 - Guides completion of development work by presenting clear options and handling chosen workflow.
* [test-driven-development](https://github.com/obra/superpowers/tree/main/skills/test-driven-development) ⭐ 276,750 | 🐛 310 | 🌐 Shell | 📅 2026-08-19 - Use when implementing any feature or bugfix, before writing implementation code.
* [using-git-worktrees](https://github.com/obra/superpowers/blob/main/skills/using-git-worktrees/) ⭐ 276,750 | 🐛 310 | 🌐 Shell | 📅 2026-08-19 - Creates isolated git worktrees with smart directory selection and safety verification.
* [artifacts-builder](https://github.com/anthropics/skills/tree/main/skills/web-artifacts-builder) ⭐ 171,228 | 🐛 1,145 | 🌐 Python | 📅 2026-08-21 - Suite of tools for creating elaborate, multi-component claude.ai HTML artifacts using modern frontend web technologies (React, Tailwind CSS, shadcn/ui).
* [Skill Seekers](https://github.com/yusufkaraaslan/Skill_Seekers) ⭐ 14,810 | 🐛 54 | 🌐 Python | 📅 2026-08-09 - Automatically converts any documentation website into a Claude AI skill in minutes. *By [@yusufkaraaslan](https://github.com/yusufkaraaslan)*
* [reddit-fetch](https://github.com/ykdojo/claude-code-tips/tree/main/skills/reddit-fetch) ⭐ 9,867 | 🐛 5 | 🌐 HTML | 📅 2026-08-23 - Fetches Reddit content via Gemini CLI when WebFetch is blocked or returns 403 errors.
* [lean-ctx](https://github.com/yvgude/lean-ctx) ⭐ 3,639 | 🐛 29 | 🌐 Rust | 📅 2026-08-24 - MCP server and context runtime for AI coding agents: session caching, AST-aware compression, and 90+ shell patterns to reduce token usage. Supports Claude Code, Cursor, Copilot, and other integrations. Install the Claude Code skill with `lean-ctx init --agent claude-code`; docs at [leanctx.com](https://leanctx.com). *By [@yvgude](https://github.com/yvgude)*
* [Playwright Browser Automation](https://github.com/lackeyjb/playwright-skill) ⭐ 3,053 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-14 - Model-invoked Playwright automation for testing and validating web applications. *By [@lackeyjb](https://github.com/lackeyjb)*
* [prompt-engineering](https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/customaize-agent/skills/prompt-engineering) ⭐ 1,352 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-22 - Teaches well-known prompt engineering techniques and patterns, including Anthropic best practices and agent persuasion principles.
* [software-architecture](https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/ddd/skills/software-architecture) ⭐ 1,352 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-22 - Implements design patterns including Clean Architecture, SOLID principles, and comprehensive software design best practices.
* [subagent-driven-development](https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/sadd/skills/subagent-driven-development) ⭐ 1,352 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-22 - Dispatches independent subagents for individual tasks with code review checkpoints between iterations for rapid, controlled development.
* [iOS Simulator](https://github.com/conorluddy/ios-simulator-skill) ⭐ 1,226 | 🐛 20 | 🌐 Python | 📅 2026-06-18 - Enables Claude to interact with iOS Simulator for testing and debugging iOS applications. *By [@conorluddy](https://github.com/conorluddy)*
* [jules](https://github.com/sanjay3290/ai-skills/tree/main/skills/jules) ⭐ 403 | 🐛 4 | 🌐 Python | 📅 2026-07-09 - Delegate coding tasks to Google Jules AI agent for async bug fixes, documentation, tests, and feature implementation on GitHub repos. *By [@sanjay3290](https://github.com/sanjay3290)*
...
* [great\_cto](https://github.com/avelikiy/great_cto) ⭐ 82 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-20 - Claude Code plugin: 7 specialised subagents (tech-lead, senior-dev, qa-engineer, security-officer, devops, l3-support, project-auditor) orchestrating a full SDLC pipeline — architecture, TDD, 12-angle code review, QA, security audit, deploy. 11 project archetypes auto-detected, 13 compliance frameworks (GDPR/PCI-DSS/HIPAA/SOC2/ISO 27001), self-improving knowledge layer that learns from every incident. *By [@avelikiy](https://github.com/avelikiy)*
* [OpenWeb](https://github.com/openweb-org/openweb) ⭐ 53 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-27 - Agent-native way to access any website. Calls the same APIs the website calls (JSON in, JSON out) with auth (cookies, JWT, CSRF, signing) auto-resolved per request. 90+ sites built in. *By [@openweb-org](https://github.com/openweb-org)*
...
* [root-cause-tracing](https://github.com/obra/superpowers/tree/main/skills/root-cause-tracing) ⭐ 276,750 | 🐛 310 | 🌐 Shell | 📅 2026-08-19 - Use when errors occur deep in execution and you need to trace back to find the original trigger.
...
* [deep-research](https://github.com/sanjay3290/ai-skills/tree/main/skills/deep-research) ⭐ 403 | 🐛 4 | 🌐 Python | 📅 2026-07-09 - Execute autonomous multi-step research using Gemini Deep Research Agent for market analysis, competitive landscaping, and literature reviews. *By [@sanjay3290](https://github.com/sanjay3290)*
...
* [brainstorming](https://github.com/obra/superpowers/tree/main/skills/brainstorming) ⭐ 276,750 | 🐛 310 | 🌐 Shell | 📅 2026-08-19 - Transform rough ideas into fully-formed designs through structured questioning and alternative exploration.
* [NotebookLM Integration](https://github.com/PleasePrompto/notebooklm-skill) ⭐ 7,672 | 🐛 37 | 🌐 Python | 📅 2025-11-21 - Lets Claude Code chat directly with NotebookLM for source-grounded answers based exclusively on uploaded documents. *By [@PleasePrompto](https://github.com/PleasePrompto)*
...
* [swiftui-design-skill](https://github.com/wholiver/swiftui-design-skill) ⭐ 174 | 🐛 0 | 📅 2026-05-01 - SwiftUI 前端设计 skill — 反 AI Slop 六条铁律、设计方向顾问、品牌资产协议、五维评审。支持 Claude Code / Cursor / Codex / OpenCode 等全部 AI agent 平台。 *By [@wholiver](https://github.com/wholiver)*
* [anydesign](https://github.com/uxKero/anydesign) ⭐ 162 | 🐛 0 | 🌐 Python | 📅 2026-06-11 - Analyzes any image, URL, or Figma file and generates a structured `design.md` with the full design system, component inventory, and reconstruction notes — portable to v0, Lovable, Cursor or any AI builder. *By [@uxKero](https://github.com/uxKero)*
...
* [kaizen](https://github.com/NeoLabHQ/context-engineering-kit/tree/master/plugins/kaizen/skills/kaizen) ⭐ 1,352 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-22 - Applies continuous improvement methodology with multiple analytical approaches, based on Japanese Kaizen philosophy and Lean methodology.
...
* [n8n-skills](https://github.com/haunchen/n8n-skills) ⭐ 390 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-23 - Enables AI assistants to directly understand and operate n8n workflows.
...
* [google-workspace-skills](https://github.com/sanjay3290/ai-skills/tree/main/skills) ⭐ 403 | 🐛 4 | 🌐 Python | 📅 2026-07-09 - Suite of Google Workspace integrations: Gmail, Calendar, Chat, Docs, Sheets, Slides, and Drive with cross-platform OAuth. *By [@sanjay3290](https://github.com/sanjay3290)*
* [outline](https://github.com/sanjay3290/ai-skills/tree/main/skills/outline) ⭐ 403 | 🐛 4 | 🌐 Python | 📅 2026-07-09 - Search, read, create, and manage documents in Outline wiki instances (cloud or self-hosted). *By [@sanjay3290](https://github.com/sanjay3290)*
...
* [Anthropic Skills Repository](https://github.com/anthropics/skills) ⭐ 171,228 | 🐛 1,145 | 🌐 Python | 📅 2026-08-21 - Official example skills
